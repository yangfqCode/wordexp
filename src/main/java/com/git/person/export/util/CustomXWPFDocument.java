...
/**
 * 自定义 XWPFDocument，并重写 createPicture()方法 处理图片，如果对于图片有其他的特殊要求，可以重新本类中的方法
 * 
 */
public class CustomXWPFDocument extends XWPFDocument {
   ...
   * @param map
   */
  public void creactPic(CustomXWPFDocument doc, XWPFParagraph paragraph, Map<?, ?> picParam) {
    ...
    try {
      ...
      createPicture(id, width, height, paragraph, ind);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public void createPicture(int id, int width, int height, XWPFParagraph paragraph, String blipId) {
    ...
    String picXml =
        "" + "<a:graphic xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\">"
            ...
            + "\" name=\"Generated\"/>" + "            <pic:cNvPicPr/>" + "         </pic:nvPicPr>"
